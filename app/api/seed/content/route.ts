...
const initialContent = [
  ...
  },
  {
    ...
    content: {
      ...
      categories: [
        { id: 'all', name: 'All Keywords', color: '#0a192f' },
        { id: 'design', name: 'Design', color: '#fc4c00' },
        { id: 'marketing', name: 'Marketing', color: '#06b6d4' },
        { id: 'ai', name: 'AI', color: '#0a192f' },
        { id: 'automation', name: 'Automation', color: '#fc4c00' },
        { id: 'ecommerce', name: 'E-commerce', color: '#F59E0B' },
        { id: 'cms', name: 'CMS', color: '#EF4444' },
        { id: 'technical', name: 'Technical', color: '#515161' },
      ],
  ...
  },
  {
    ...
    content: {
      ...
      stages: [
        { name: 'Visitors', percentage: 100, color: '#0a192f' },
        { name: 'Product Views', percentage: 65, color: '#fc4c00' },
        { name: 'Add to Cart', percentage: 35, color: '#0a192f' },
        { name: 'Checkout', percentage: 20, color: '#fc4c00' },
        { name: 'Purchase', percentage: 15, color: '#06b6d4' },
      ],
  ...
  },
  {
    ...
    content: {
      ...
      colorSwatches: [
        { name: 'Midnight Black', color: '#0a192f', image: 'black' },
        { name: 'Ocean Blue', color: '#0a192f', image: 'blue' },
        { name: 'Sunset Orange', color: '#fc4c00', image: 'orange' },
        { name: 'Forest Green', color: '#06b6d4', image: 'green' },
      ],
      productLabel: 'SHOP',
  ...
  },
  {
    ...
    content: {
      ...
      metrics: [
        { label: 'Revenue', target: 125000, unit: '$', color: '#06b6d4' },
        { label: 'Orders', target: 1250, unit: '', color: '#0a192f' },
        { label: 'Conversion Rate', target: 3.8, unit: '%', color: '#fc4c00' },
