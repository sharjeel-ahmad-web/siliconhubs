    ...
    <div className="min-h-full">
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-lg bg-orange px-4 py-2 text-white transition-colors hover:bg-orange/80 disabled:opacity-50"
        >
          <RefreshCw
      ...
      {loading ? (
        ...
        <div className="py-12 text-center text-slate-400">
          <p>
            ...
            <code className="rounded bg-navy px-2 py-1">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {filteredSections.map((section, index) => (
            <div
              ...
              className="rounded-xl border border-slate-700/50 bg-navy p-5 transition-all hover:border-cyan/50"
            >
              {/* Header */}
              ...
              <div className="mb-4 space-y-2 text-xs">
                <div className="flex items-center gap-2 text-slate-500">
                  <FileJson className="h-3 w-3 text-cyan" />
              ...
              {/* Preview */}
              <div className="mb-4 rounded-lg bg-navy p-3">
              ...
              <div className="flex items-center justify-between border-t border-slate-700/50 pt-3">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg bg-cyan px-3 py-1.5 text-sm text-white transition-colors hover:bg-cyan/80"
                >
      ...
      {showModal && editingSection && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-navy/70 p-4">
          <div className="flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl bg-navy">
            {/* Modal Header */}
            ...
            {/* Mode Toggle */}
            <div className="flex gap-2 border-b border-slate-700 bg-navy p-4">
              <button
                onClick={() => setPreviewMode(false)}
                className={`rounded-lg px-4 py-2 text-sm font-medium transition-colors ${
                  !previewMode
                    ? 'bg-cyan text-white'
                    : 'bg-navy text-slate-400 hover:text-white'
                }`}
              >
              ...
              {previewMode ? (
                ...
                <div>
                  <textarea
                    ...
                    rows={18}
                    className="w-full rounded-lg border border-slate-700 bg-navy px-4 py-3 font-mono text-sm text-white focus:border-cyan focus:outline-none"
                    placeholder="Enter JSON content..."
                  />
                  <div className="mt-3 rounded-lg bg-navy p-3 text-xs text-slate-400">
                    <p className="mb-2 font-semibold">💡 Editing Tips:</p>
                    <ul className="list-inside list-disc space-y-1">
                      <li>
                        Images should be in{' '}
                        <code className="rounded bg-navy px-1 py-0.5">
                          {editingSection.mediaPath}
                        </code>
                      </li>
                      <li>
            ...
            <div className="flex justify-end gap-3 border-t border-slate-700 p-6">
              ...
              <button
                ...
                className="rounded-lg bg-cyan px-6 py-2 text-white transition-colors hover:bg-cyan/80 disabled:cursor-not-allowed disabled:opacity-50"
              >
