...
export const portfolioTags = [
  'Web Design', 'Shopify', 'WordPress', 'SEO', 'Chatbot Development',
  'N8N Automations', 'React', 'Next.js', 'Tailwind', 'TypeScript',
  'Figma', 'Stripe', 'OpenAI', 'Analytics', 'SaaS', 'AI/ML',
];
...
export const portfolioCta = {
  ...
  subtitle: "Let's create something extraordinary together. Get in touch today.",
  ctaText: 'Contact Us',
  ctaLink: '/contact',
};
...
export const portfolioCaseStudies: PortfolioCaseStudy[] = [
  { img: '/media/portfolio/case-studies/enterprise-platform.jpg', title: 'Enterprise Platform', desc: 'Built a scalable enterprise platform handling 1M+ daily transactions with 99.99% uptime.', sliderName: 'enterprise' },
  { img: '/media/portfolio/case-studies/mobile-app.jpg', title: 'Mobile App Launch', desc: 'Launched a mobile app achieving 100K+ downloads in the first month with 4.8 star rating.', sliderName: 'mobile' },
  { img: '/media/portfolio/case-studies/ai-integration.jpg', title: 'AI Integration', desc: 'Integrated AI-powered features reducing manual processing time by 85% across operations.', sliderName: 'ai' },
  { img: '/media/portfolio/case-studies/digital-transformation.jpg', title: 'Digital Transformation', desc: 'Led complete digital transformation resulting in 200% increase in online engagement.', sliderName: 'digital' },
];
...
export const portfolioFeaturedSlides: FeaturedSlide[] = portfolioProjects.slice(0, 4).map((p) => ({
  id: p.id,
  title: p.title,
...
export const portfolioAdvantages: PortfolioAdvantagesContent = {
  ...
  features: [
    { title: 'Lightning Fast', description: 'Optimized performance with sub-second load times and smooth interactions.', icon: 'Zap', color: '#37AFE1' },
    { title: 'Powerful Tech', description: 'Built with cutting-edge technologies for scalability and reliability.', icon: 'Cpu', color: '#F58122' },
    { title: 'Secure & Safe', description: 'Enterprise-grade security with best practices and regular audits.', icon: 'Lock', color: '#37AFE1' },
    { title: 'AI Powered', description: 'Intelligent automation and AI integration for smarter solutions.', icon: 'Sparkles', color: '#F58122' },
  ],
};
