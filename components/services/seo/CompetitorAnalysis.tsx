    ...
    <div className="relative min-h-[700px] w-full overflow-hidden rounded-2xl bg-[#0F172A] p-8">
      ...
      <div className="absolute inset-0 opacity-5">
        <motion.div
          ...
          style={{
            background:
              'conic-gradient(from 0deg, #F97316, #2563EB, #F97316, #2563EB)',
          }}
          animate={{
            rotate: 360,
          }}
            ...
            >
              <div className="mb-2 flex items-center gap-4">
                <div
                  ...
                  ${isYourSite ? 'bg-[#F97316] text-white' : 'bg-[#2563EB] text-white'}
                `}
                >
                  #{site.rank}
                </div>
            ...
            return (
              ...
              >
                <div className="text-center">
                  ...
                  ${parseFloat(advantage) > 0 ? 'bg-[#F97316]/20 text-[#F97316]' : 'bg-[#2563EB]/20 text-[#2563EB]'}
                `}
                  >
