...
export function CareersHero({ content, openJobsCount }: CareersHeroProps) {
  return (
    ...
    >
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 pb-16 pt-10 md:pb-24 md:pt-16 lg:grid-cols-2">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7, ease: [0.23, 0.86, 0.39, 0.96] }}
        >
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#FC4C00]/25 bg-white/70 px-4 py-2 backdrop-blur-sm">
          ...
          <h1
            id="careers-heading"
            className="mb-5 text-4xl font-extrabold leading-tight tracking-tight text-[#14213D] md:text-5xl lg:text-6xl"
          >
            {content.title}{' '}
          ...
          <p className="mb-8 max-w-xl text-lg leading-relaxed text-[#5F6368]">
            {content.description}
          </p>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-6 text-sm text-[#5F6368]">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="relative mx-auto max-w-md overflow-hidden rounded-[2rem] border border-white/60 shadow-2xl shadow-[#FC4C00]/10">
