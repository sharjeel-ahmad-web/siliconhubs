...
export function Hero1({
  ...
  return (
    <section
      id="hero"
      className="relative mx-auto min-h-[70vh] w-full rounded-b-xl bg-[linear-gradient(to_bottom,#000,#000_30%,#1a3a4a_78%,#37AFE1_100%)] px-6 pt-28 text-center md:px-8"
    >
      {/* Grid BG */}
      <div 
        ...
        style={{ maskImage: 'radial-gradient(ellipse 80% 50% at 50% 0%, #000 70%, transparent 110%)' }}
      />

      {/* Radial Accent Container */}
      <div className="absolute inset-x-0 bottom-0 h-[350px] overflow-hidden lg:h-[525px]">
        <div 
          className="absolute bottom-[-280px] left-1/2 h-[350px] w-[490px] -translate-x-1/2 rounded-[100%] border border-[#37AFE1]/30 md:h-[350px] md:w-[770px] lg:bottom-[-420px] lg:h-[525px] lg:w-[980px]" 
          style={{ background: 'radial-gradient(closest-side at 50% 50%, #000 82%, #37AFE1)' }}
        />
      </div>
      ...
      <div className="relative z-10 pb-12 pt-12">
        ...
        {eyebrow && (
          <a href="#" className="group inline-block">
            <span className="mx-auto flex w-fit items-center justify-center rounded-3xl border-[2px] border-[#37AFE1]/20 bg-gradient-to-tr from-[#37AFE1]/10 via-gray-400/5 to-transparent px-5 py-2 text-sm uppercase tracking-tight text-gray-400">
              {eyebrow}
        ...
        {ctaLabel && (
          <div className="flex justify-center">
            <ParticleWrapper>
              <a href={ctaHref ?? '#'}>
                <StarButton className="z-20 mt-[-20px] w-fit text-center text-lg tracking-tighter shadow-[0_0_30px_rgba(245,129,34,0.4)] md:w-52">
                  {ctaLabel}
                </StarButton>
              </a>
            </ParticleWrapper>
