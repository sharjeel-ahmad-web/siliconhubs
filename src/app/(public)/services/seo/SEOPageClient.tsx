...
import {
  ...
  TrafficGrowth,
  CompetitorAnalysis,
} from '@/modules/public/components/services/seo';
import { Web3MediaHero } from '@/modules/public/components/web3media-hero';
  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      <Web3MediaHero
        ...
        floatingIcons={[
          {
            icon: <Search className="h-8 w-8 text-[#06b6d4]" />,
            label: 'Keywords',
            position: { x: '8%', y: '25%' },
          },
          {
            icon: <TrendingUp className="h-8 w-8 text-[#06b6d4]" />,
            label: 'Rankings',
            position: { x: '12%', y: '60%' },
          },
          {
            icon: <Target className="h-8 w-8 text-[#fc4c00]" />,
            label: 'Traffic',
            position: { x: '82%', y: '20%' },
          },
          {
            icon: <BarChart3 className="h-8 w-8 text-[#fc4c00]" />,
            label: 'Analytics',
            position: { x: '78%', y: '55%' },
          },
        ]}
