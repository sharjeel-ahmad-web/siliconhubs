...
import TagCloud from '@/modules/public/components/portfolio/TagCloud';
import ProjectCard from '@/modules/public/components/portfolio/ProjectCard';
import ProjectDetail from '@/modules/public/components/portfolio/ProjectDetail';
import PortfolioFeatures from '@/modules/public/sections/PortfolioFeatures';
import CaseStudiesCarousel from '@/modules/public/sections/CaseStudiesCarousel';
import MiniCTA from '@/modules/public/sections/MiniCTA';
import { ImageAccordionHero } from '@/modules/public/components/interactive-image-accordion';
...
const FeaturedProjectsCarousel = dynamic(
  () => import('@/modules/public/sections/FeaturedProjectsCarousel'),
  { ssr: false }
);
