              ...
              {toBlogList(listToRender).map((blog, index) => (
                ...
                >
                  <Link href={blog?.slug ? `/blog/${blog.slug}` : '/blog'}>
                    <div className="overflow-hidden rounded-2xl border border-slate-800 bg-[#1E293B]/50 transition-all duration-500 hover:border-[#06b6d4]/50 hover:shadow-xl hover:shadow-[#06b6d4]/10">
                      {/* Thumbnail */}
                      <div className="relative h-52 overflow-hidden">
                        ...
                        <span className="absolute left-4 top-4 z-20 rounded-full bg-[#06b6d4] px-3 py-1 text-xs font-medium text-white">
                          {blog.category}
                        </span>
                      </div>
                      ...
                      {/* Content */}
                      <div className="p-6">
                        <h3 className="mb-3 line-clamp-2 text-xl font-bold text-white transition-colors group-hover:text-[#06b6d4]">
                          {blog.title}
                        </h3>
                        ...
                        <div className="flex items-center justify-between text-xs text-slate-500">
                          ...
                          <ArrowRight className="h-4 w-4 text-[#06b6d4] transition-transform group-hover:translate-x-1" />
                        </div>
                      </div>
                    </div>
                  </Link>
