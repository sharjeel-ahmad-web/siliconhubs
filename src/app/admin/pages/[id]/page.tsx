  ...
  'services-webdesign': {
    ...
    styleShowcase: {
      ...
      fonts: [
        ...
        { name: 'Tech', family: 'Inter, monospace' },
        { name: 'Elegant', family: 'Poppins, sans-serif' },
      ],
    },
  },
  'services-chatbot': {
      ...
      return (
        <div className="space-y-2">
          ...
          <textarea
            ...
            rows={6}
            className="w-full rounded-lg border border-slate-700 bg-[#0F172A] px-3 py-2 font-mono text-sm text-white focus:border-[#06b6d4] focus:outline-none"
          />
      ...
      return (
        <div className="space-y-1">
          ...
          <textarea
            ...
            rows={3}
            className="w-full rounded-lg border border-slate-700 bg-[#0F172A] px-3 py-2 text-white focus:border-[#06b6d4] focus:outline-none"
          />
        </div>
      );
    }
  ...
  if (!pageData) {
    return (
      <div className="flex min-h-full flex-col items-center justify-center">
        ...
        <Link href="/admin/pages" className="text-[#06b6d4] hover:underline">
          ← Back to Pages
        </Link>
      </div>
    );
          ...
          <div className="flex max-h-[90vh] w-full max-w-3xl flex-col overflow-hidden rounded-2xl bg-[#1E293B]">
                ...
                <div className="border-t border-slate-700 pt-4">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      id="newFieldName"
                      className="flex-1 rounded-lg border border-slate-700 bg-[#0F172A] px-3 py-2 text-sm text-white focus:border-[#06b6d4] focus:outline-none"
                    />
                    <button
                      onClick={() => {
            ...
            <div className="flex justify-end gap-3 border-t border-slate-700 p-6">
              ...
              <button
                onClick={saveSection}
                disabled={saving}
                className="flex items-center gap-2 rounded-lg bg-[#06b6d4] px-6 py-2 text-white transition-colors hover:bg-[#06b6d4]/80 disabled:opacity-50"
              >
                {saving ? (
                  <>
