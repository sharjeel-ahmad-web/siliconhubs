          ...
          {pages.map((page) => {
            ...
            return (
              <Link
                ...
                className="group rounded-xl border border-slate-700/50 bg-[#1E293B] p-5 transition-all hover:border-[#06b6d4]/50 hover:shadow-lg"
              >
                <div className="flex items-start gap-4">
                  <div className="rounded-lg bg-slate-700 p-3 transition-colors group-hover:bg-[#06b6d4]/20">
                    <Icon className="h-6 w-6 text-[#06b6d4]" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold text-white transition-colors group-hover:text-[#06b6d4]">
                      {page.label}
                    </h3>
