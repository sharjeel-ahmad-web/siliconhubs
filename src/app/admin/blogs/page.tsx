    ...
    <div className="min-h-full">
      <div className="mb-8 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-lg bg-[#06b6d4] px-4 py-2 text-white transition-colors hover:bg-[#06b6d4]/80"
        >
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full rounded-lg border border-slate-700 bg-[#1E293B] py-3 pl-10 pr-4 text-white placeholder-slate-400 focus:border-[#06b6d4] focus:outline-none"
        />
      </div>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="mb-1 flex items-center gap-2">
                  ...
                  {blog.featured && (
                    <Star className="h-4 w-4 fill-[#fc4c00] text-[#fc4c00]" />
                  )}
                </div>
                ...
                <div className="mt-2 flex items-center gap-3">
                  <span className="rounded bg-[#06b6d4]/20 px-2 py-1 text-xs text-[#06b6d4]">
                    {blog.category}
                  </span>
                  <span
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`rounded-lg p-2 transition-colors ${
                    blog.featured
                      ? 'bg-[#fc4c00]/20 text-[#fc4c00]'
                      : 'bg-slate-700 text-slate-400 hover:text-[#fc4c00]'
                  }`}
                  title={
                ...
                <button
                  ...
                  className="rounded-lg bg-slate-700 p-2 text-slate-300 transition-colors hover:bg-[#06b6d4] hover:text-white"
                >
          ...
          <div className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-2xl bg-[#1E293B]">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 p-6">
              ...
              <div className="flex items-center gap-6">
                <label className="flex cursor-pointer items-center gap-2">
                  <input
                    ...
                    className="h-4 w-4 rounded border-slate-600 text-[#fc4c00] focus:ring-[#fc4c00]"
                  />
              ...
              <div className="flex justify-end gap-3 border-t border-slate-700 pt-4">
                ...
                <button
                  type="submit"
                  className="rounded-lg bg-[#06b6d4] px-6 py-2 text-white transition-colors hover:bg-[#06b6d4]/80"
                >
