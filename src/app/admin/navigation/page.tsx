    ...
    <div className="min-h-full">
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="flex items-center gap-2 rounded-lg bg-[#fc4c00] px-6 py-2 text-white transition-colors hover:bg-[#e0741d] disabled:opacity-50"
        >
              ...
              <div className="space-y-4 p-4 pt-0">
                <label className="flex cursor-pointer items-center gap-2">
                  <input
                    ...
                    className="h-4 w-4 rounded border-slate-600 text-[#06b6d4] focus:ring-[#06b6d4]"
                  />
          ...
          <div className="overflow-hidden rounded-xl border border-slate-700/50 bg-[#1E293B]">
            ...
            {expandedSections.includes('navLinks') && (
              <div className="space-y-3 p-4 pt-0">
                {settings.header.navLinks.map((link, index) => (
                  ...
                  >
                    ...
                    <input
                      ...
                      className="flex-1 rounded border border-slate-700 bg-slate-800 px-3 py-1.5 text-sm text-white focus:border-[#06b6d4] focus:outline-none"
                      placeholder="Label"
                    />
                    <input
                      type="text"
                ...
                <button
                  onClick={addNavLink}
                  className="flex items-center gap-2 rounded-lg px-4 py-2 text-[#06b6d4] transition-colors hover:bg-[#06b6d4]/10"
                >
          ...
          <div className="overflow-hidden rounded-xl border border-slate-700/50 bg-[#1E293B]">
            <div className="flex items-center justify-between border-b border-slate-700/50 p-4">
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-lg px-3 py-1.5 text-sm text-[#06b6d4] transition-colors hover:bg-[#06b6d4]/10"
              >
                <Plus className="h-4 w-4" />
                Add Column
              </button>
                ...
                <div key={colIndex} className="rounded-lg bg-[#0F172A] p-4">
                  <div className="mb-3 flex items-center gap-3">
                    <input
                      ...
                      className="flex-1 rounded border border-slate-700 bg-slate-800 px-3 py-1.5 font-medium text-white focus:border-[#06b6d4] focus:outline-none"
                  ...
                  <div className="ml-4 space-y-2">
                    {column.links.map((link, linkIndex) => (
                      <div key={linkIndex} className="flex items-center gap-2">
                        <input
                          ...
                          className="flex-1 rounded border border-slate-700 bg-slate-800 px-2 py-1 text-sm text-white focus:border-[#06b6d4] focus:outline-none"
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 rounded px-2 py-1 text-xs text-[#06b6d4] transition-colors hover:bg-[#06b6d4]/10"
                    >
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <input
                          ...
                          className="w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-sm text-white focus:border-[#06b6d4] focus:outline-none"
              ...
              {socialPlatforms
                ...
                .map(({ key, label, Icon, color }) => (
                  <a
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-full border border-[#06b6d4]/30 bg-[#0F172A] text-[#fc4c00] transition-colors hover:border-[#06b6d4] hover:text-[#06b6d4]"
                    title={label}
                  >
