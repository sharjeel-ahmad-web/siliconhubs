    ...
    <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  className="rounded-lg bg-[#06b6d4] px-4 py-2 font-medium text-white disabled:opacity-50"
                >
      ...
      {!data?.connected && (
        <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-12 text-center">
          ...
          <button
            onClick={() => setShowSetup(true)}
            className="rounded-lg bg-[#06b6d4] px-6 py-3 font-medium text-white transition-colors hover:bg-[#06b6d4]/90"
          >
            Connect Search Console
          </button>
        </div>
          ...
          {data.dailyData && (
            <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-6">
                  ...
                  return (
                    ...
                    >
                      <motion.div
                        ...
                        className="w-full rounded-t bg-[#fc4c00]/30"
                      />
                      <motion.div
                        initial={{ height: 0 }}
                        animate={{ height: `${clicksHeight}%` }}
                        transition={{ duration: 0.5, delay: index * 0.02 }}
                        className="w-full rounded-t bg-[#06b6d4]"
                      />
              ...
              <div className="mt-4 flex justify-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  <div className="h-3 w-3 rounded bg-[#fc4c00]/30" />
            ...
            <div className="flex border-b border-slate-700">
              <button
                ...
                className={`flex-1 px-6 py-4 font-medium transition-colors ${
                  activeTab === 'queries'
                    ? 'border-b-2 border-[#06b6d4] bg-[#0F172A] text-white'
                    ...
                    <tbody>
                      {data.topQueries.map((query, index) => (
                        ...
                        >
                          ...
                          <td className="py-3 text-right font-semibold text-[#06b6d4]">
