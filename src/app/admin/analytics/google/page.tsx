    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="flex items-center gap-3 text-3xl font-bold text-white">
            <BarChart3 className="h-8 w-8 text-[#fc4c00]" />
            Google Analytics
          </h1>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-700 bg-[#0F172A] px-4 py-2 text-white focus:border-[#fc4c00] focus:outline-none"
                />
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  className="rounded-lg bg-[#fc4c00] px-4 py-2 font-medium text-white disabled:opacity-50"
                >
      ...
      {!data?.connected && (
        <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-12 text-center">
          ...
          <button
            onClick={() => setShowSetup(true)}
            className="rounded-lg bg-[#fc4c00] px-6 py-3 font-medium text-white transition-colors hover:bg-[#fc4c00]/90"
          >
            Connect Google Analytics
          </button>
        </div>
                    ...
                    <div key={device.device}>
                      ...
                      <div className="h-2 w-full rounded-full bg-slate-700">
                        <motion.div
                          ...
                          className="h-2 rounded-full bg-[#fc4c00]"
                        />
                      </div>
                    </div>
                  ))}
