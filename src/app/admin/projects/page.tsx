...
export default function ProjectsPage() {
  ...
  return (
    <div className="min-h-full">
      ...
      {/* Info Banner */}
      <div className="mb-6 rounded-lg border border-[#06b6d4]/30 bg-[#06b6d4]/10 p-4">
        <p className="text-sm text-[#06b6d4]">
          <strong>Note:</strong> Portfolio projects are now managed via the CMS.
          Edit them in{' '}
          <code className="rounded bg-[#06b6d4]/20 px-1">/admin/pages</code>{' '}
          under the Portfolio Page section. Images should be placed in{' '}
          <code className="rounded bg-[#06b6d4]/20 px-1">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-2 flex flex-wrap gap-1">
                  {project.tags?.slice(0, 3).map((tag, i) => (
                    <span
                      key={i}
                      className="rounded bg-[#06b6d4]/20 px-2 py-0.5 text-xs text-[#06b6d4]"
                    >
                      {tag}
                    </span>
                  ))}
