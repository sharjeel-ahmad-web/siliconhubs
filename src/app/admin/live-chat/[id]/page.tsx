    ...
    <div className="flex min-h-full flex-col">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#1E293B] text-lg font-semibold text-[#fc4c00]">
                ...
                className={`max-w-[70%] rounded-2xl px-4 py-3 ${
                  msg.role === 'user'
                    ...
                    : msg.isHuman
                      ...
                      : 'rounded-br-md bg-[#06b6d4]/20 text-slate-200'
                }`}
              >
        ...
        <div className="border-t border-slate-700/50 p-4">
          <form onSubmit={handleSendReply} className="flex gap-3">
            <input
              ...
              className="flex-1 rounded-lg border border-slate-700 bg-[#0F172A] px-4 py-3 text-white placeholder-slate-500 focus:border-[#06b6d4] focus:outline-none"
            />
            <button
              type="submit"
              disabled={!replyMessage.trim() || sending}
              className="flex items-center gap-2 rounded-lg bg-[#fc4c00] px-6 py-3 text-white transition-colors hover:bg-[#e0741d] disabled:cursor-not-allowed disabled:opacity-50"
            >
              {sending ? (
