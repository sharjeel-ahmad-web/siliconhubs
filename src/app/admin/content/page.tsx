    ...
    <div className="min-h-full">
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-lg bg-[#fc4c00] px-4 py-2 text-white transition-colors hover:bg-[#fc4c00]/80 disabled:opacity-50"
        >
          <RefreshCw
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {filteredSections.map((section, index) => (
            <div
              ...
              className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-5 transition-all hover:border-[#06b6d4]/50"
            >
              {/* Header */}
              ...
              <div className="mb-4 space-y-2 text-xs">
                <div className="flex items-center gap-2 text-slate-500">
                  <FileJson className="h-3 w-3 text-[#06b6d4]" />
                  <span className="truncate">/content/{section.page}.json</span>
                </div>
                {section.mediaPath && (
                  <div className="flex items-center gap-2 text-slate-500">
                    <FolderOpen className="h-3 w-3 text-[#fc4c00]" />
              ...
              <div className="flex items-center justify-between border-t border-slate-700/50 pt-3">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg bg-[#06b6d4] px-3 py-1.5 text-sm text-white transition-colors hover:bg-[#06b6d4]/80"
                >
          ...
          <div className="flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden rounded-2xl bg-[#1E293B]">
              ...
              {previewMode ? (
                ...
                <div>
                  <textarea
                    ...
                    rows={18}
                    className="w-full rounded-lg border border-slate-700 bg-[#0F172A] px-4 py-3 font-mono text-sm text-white focus:border-[#06b6d4] focus:outline-none"
            ...
            <div className="flex justify-end gap-3 border-t border-slate-700 p-6">
              ...
              <button
                ...
                className="rounded-lg bg-[#06b6d4] px-6 py-2 text-white transition-colors hover:bg-[#06b6d4]/80 disabled:cursor-not-allowed disabled:opacity-50"
              >
