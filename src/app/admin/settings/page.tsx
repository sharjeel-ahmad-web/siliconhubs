...
export default function SettingsPage() {
  ...
  // General Settings
  const [siteName, setSiteName] = useState('Silicon Hubs');
  ...
  const [metaTitle, setMetaTitle] = useState(
    'Silicon Hubs | Digital Excellence Delivered'
  );
    ...
    async function loadSettings() {
      try {
        ...
        if (response.ok) {
          ...
          if (data.general) {
            setSiteName(data.general.siteName || 'Silicon Hubs');
            setSiteDescription(
    ...
    <div className="min-h-full">
      <div className="mb-8 flex items-center justify-between">
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="flex items-center gap-2 rounded-lg bg-[#06b6d4] px-4 py-2 text-white transition-colors hover:bg-[#06b6d4]/80 disabled:opacity-50"
        >
          {saving ? (
            <>
      ...
      {loading && (
        <div className="mb-6 flex items-center gap-3 rounded-lg border border-slate-700/50 bg-[#1E293B] p-4">
          <div className="h-5 w-5 animate-spin rounded-full border-2 border-[#06b6d4]/30 border-t-[#06b6d4]" />
          ...
          <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-lg border border-slate-700 bg-[#0F172A] px-4 py-2 text-white focus:border-[#06b6d4] focus:outline-none"
                      />
                    </div>
                    <div>
                      <label className="mb-1 block text-sm font-medium text-slate-300">
                ...
                <div className="space-y-4">
                    ...
                    <div className="mb-4 rounded-lg border border-slate-700 bg-[#0F172A] p-4">
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-xs text-slate-500">
                          <span className="text-[#06b6d4]">How to get:</span> Go
                          to{' '}
                          <a
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full rounded-lg border border-slate-700 bg-[#0F172A] px-4 py-2 font-mono text-sm text-white focus:border-[#06b6d4] focus:outline-none"
                    />
                  </div>
                      ...
                      <div className="space-y-2">
                        <label className="flex items-center gap-3">
                          <input
                            type="checkbox"
                            defaultChecked
                            className="h-4 w-4 rounded border-slate-600 text-[#06b6d4]"
                          />
            ...
            {activeTab === 'social' && (
              <div className="space-y-6">
                ...
                <div className="rounded-lg border border-[#06b6d4]/30 bg-[#06b6d4]/10 p-4">
                  <p className="mb-1 font-medium text-[#06b6d4]">
                ...
                <div className="space-y-4">
                  <label className="flex items-center justify-between rounded-lg border border-slate-700 bg-[#0F172A] p-4">
                    ...
                    <input
                      ...
                      className="h-5 w-5 rounded border-slate-600 text-[#06b6d4] focus:ring-[#06b6d4]"
                    />
                  </label>
                  <label className="flex items-center justify-between rounded-lg border border-slate-700 bg-[#0F172A] p-4">
                    <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="rounded-lg border border-slate-700 bg-[#0F172A] p-4">
                          ...
                          <ol className="list-inside list-decimal space-y-2 text-sm text-slate-400">
                            ...
                            <li>
                              Name your app (e.g., "Silicon Hubs Notifications")
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <input
                          ...
                          value={primaryColor}
                          onChange={(e) => setPrimaryColor(e.target.value)}
                          className="flex-1 rounded-lg border border-slate-700 bg-[#0F172A] px-4 py-2 text-white focus:border-[#06b6d4] focus:outline-none"
                        />
                      </div>
                    </div>
                    <div>
                  ...
                  <div className="rounded-lg border border-slate-700 bg-[#0F172A] p-4">
                    ...
                    <div className="mb-3 rounded-lg bg-[#1E293B] p-3">
                      <p className="mb-2 text-xs text-slate-400">
                        <span className="text-[#06b6d4]">Current Status:</span>{' '}
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-xs text-slate-500">
                        <span className="text-[#06b6d4]">To update:</span> Edit
            ...
            {activeTab === 'email' && (
              <div className="space-y-6">
                ...
                {/* Info Box */}
                <div className="rounded-lg border border-[#06b6d4]/30 bg-[#06b6d4]/10 p-4">
                  <p className="mb-2 font-medium text-[#06b6d4]">
                    When to use SMTP?
                  </p>
                  <p className="text-sm text-slate-300">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select className="w-full rounded-lg border border-slate-700 bg-[#0F172A] px-4 py-2 text-white focus:border-[#06b6d4] focus:outline-none">
                  ...
                  <div className="flex gap-3">
                    <button className="rounded-lg bg-[#06b6d4] px-4 py-2 text-white transition-colors hover:bg-[#06b6d4]/80">
                      Save SMTP Settings
                    </button>
                    <button className="rounded-lg bg-slate-700 px-4 py-2 text-white transition-colors hover:bg-slate-600">
                      Send Test Email
                ...
                <div className="space-y-4">
                    ...
                    <div className="mb-3 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-400">
                            MongoDB Atlas - silicon-hubs cluster
                          </p>
                        </div>
                      </div>
                      <span className="rounded-full bg-green-500/20 px-3 py-1 text-sm text-green-400">
                  ...
                  <div className="rounded-lg border border-slate-700 bg-[#0F172A] p-4">
                    ...
                    <div className="mb-4 grid grid-cols-2 gap-3">
                      <button className="rounded-lg bg-[#06b6d4]/20 px-4 py-2 text-sm text-[#06b6d4] transition-colors hover:bg-[#06b6d4]/30">
                        Seed Team Members
                      </button>
                      <button className="rounded-lg bg-[#06b6d4]/20 px-4 py-2 text-sm text-[#06b6d4] transition-colors hover:bg-[#06b6d4]/30">
                        Seed Testimonials
