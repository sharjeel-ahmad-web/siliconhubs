...
// e.g., /public/media/home/team/alex.png -> silicon-hubs/media/home/team/alex
...
function getCloudinaryPath(localPath: string): {
  ...
  // Build the Cloudinary folder path - prefix with silicon-hubs
  const cloudinaryFolder =
    folderParts.length > 0
      ? `silicon-hubs/${folderParts.join('/')}`
      : 'silicon-hubs';
