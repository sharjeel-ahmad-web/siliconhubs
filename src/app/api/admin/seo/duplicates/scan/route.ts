  ...
  try {
    ...
    const duplicates = [
      ...
      },
      {
        ...
        contentPreview:
          'Silicon Hubs is a full-service digital agency specializing in web development, automation, and AI solutions. We help businesses transform their digital presence...',
      },
    ];
