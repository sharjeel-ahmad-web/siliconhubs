      ...
      milestones: [
        {
          ...
          description:
            'Silicon Hubs was born with a vision to revolutionize digital experiences.',
          era: 'foundation',
          icon: '🚀',
        },
        {
      ...
      tourStops: [
        {
          ...
          name: 'Reception Area',
          description:
            'Welcome to Silicon Hubs! Our modern reception area sets the tone for innovation.',
          image: '🏢',
          hotspots: [
            {
              id: '1-1',
