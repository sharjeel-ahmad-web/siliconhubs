...
const defaultMeta: Record<string, Partial<PageMeta>> = {
  '/': {
    title: 'Silicon Hubs | Digital Excellence Delivered',
    description:
      'We craft stunning websites, powerful automations, and intelligent chatbots that transform your digital presence.',
  },
  '/about': {
    title: 'About Us | Silicon Hubs',
    description:
      'Meet the team behind Silicon Hubs. We are passionate developers, designers, and strategists dedicated to creating exceptional digital experiences.',
  },
  '/services': {
    title: 'Our Services | Silicon Hubs',
    description:
  ...
  '/portfolio': {
    title: 'Our Work | Silicon Hubs',
    description:
      'Explore our portfolio of successful projects and see how we have helped businesses transform their digital presence.',
  },
  '/contact': {
    title: 'Contact Us | Silicon Hubs',
    description:
      'Get in touch with Silicon Hubs. Let us discuss your project and how we can help you achieve your digital goals.',
  },
  '/blog': {
    title: 'Blog | Silicon Hubs',
    description:
      'Insights, tips, and news about web development, automation, AI, and digital marketing from the Silicon Hubs team.',
  },
  '/services/chatbot-development': {
    title: 'AI Chatbot Development Services | Silicon Hubs',
    description:
  ...
  '/services/n8n-automations': {
    title: 'N8N Automation Services | Silicon Hubs',
    description:
  ...
  '/services/web-design': {
    title: 'Web Design Services | Silicon Hubs',
    description:
  ...
  '/services/wordpress': {
    title: 'WordPress Development Services | Silicon Hubs',
    description:
  ...
  '/services/shopify': {
    title: 'Shopify Development Services | Silicon Hubs',
    description:
  ...
  '/services/seo': {
    title: 'SEO Services | Silicon Hubs',
    description:
  ...
  '/services/saas': {
    title: 'SaaS Development Services | Silicon Hubs',
    description:
...
export async function getMetaTags(path: string): Promise<Metadata> {
  ...
  try {
    ...
    const title = meta?.title || defaults.title || 'Silicon Hubs';
    ...
    const defaults = defaultMeta[path] || {};
    return {
      title: defaults.title || 'Silicon Hubs',
