...
export const portfolioAdvantages: PortfolioAdvantagesContent = {
  ...
  features: [
    { title: 'Lightning Fast', description: 'Optimized performance with sub-second load times and smooth interactions.', icon: 'Zap', color: '#06b6d4' },
    { title: 'Powerful Tech', description: 'Built with cutting-edge technologies for scalability and reliability.', icon: 'Cpu', color: '#fc4c00' },
    { title: 'Secure & Safe', description: 'Enterprise-grade security with best practices and regular audits.', icon: 'Lock', color: '#06b6d4' },
    { title: 'AI Powered', description: 'Intelligent automation and AI integration for smarter solutions.', icon: 'Sparkles', color: '#fc4c00' },
  ],
};
