      ...
      >
        <div className="sticky top-0" style={{ height: '140vh' }}>
          ...
          <div className="absolute left-0 right-0 top-0 z-30 pb-4 pt-20 text-center">
            ...
            >
              <span className="mb-2 block text-sm font-semibold uppercase tracking-wider text-[#fc4c00]">
                Portfolio
              </span>
          ...
          <div className="absolute inset-0">
            ...
            {/* Center dot */}
            <motion.div
              className="absolute h-5 w-5 rounded-full bg-[#fc4c00]"
              style={{
                left: '50%',
                top: '55%',
                transform: 'translate(-50%, -50%)',
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div className="flex h-8 w-5 justify-center rounded-full border border-[#64748B] pt-1">
                <motion.div
                  className="h-2 w-1 rounded-full bg-[#fc4c00]"
                  animate={{ y: [0, 8, 0] }}
