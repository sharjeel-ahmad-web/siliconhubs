...
import {
  Gallery,
  ImageModal,
} from '@/modules/public/components/react-tailwind-image-gallery';
    ...
    <section className="bg-black px-4 py-12 sm:px-6 md:py-16 lg:px-8">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mb-4 flex justify-center sm:mb-6">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#06b6d4]/30 bg-[#06b6d4]/10 px-4 py-2 text-xs backdrop-blur-sm sm:px-5 sm:text-sm">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 md:grid-cols-3 lg:grid-cols-4">
          {galleryData.map((img) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 flex items-end bg-gradient-to-t from-black/90 via-[#06b6d4]/10 to-transparent p-4 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
