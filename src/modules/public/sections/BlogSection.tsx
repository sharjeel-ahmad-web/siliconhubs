  ...
  return (
    <section className="bg-black px-4 py-12 sm:px-6 md:py-16 lg:px-8">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-10 top-20 h-72 w-72 rounded-full bg-[#06b6d4]/5 blur-3xl" />
        <div className="absolute bottom-20 right-10 h-96 w-96 rounded-full bg-[#fc4c00]/5 blur-3xl" />
      </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          >
            <Link href={featuredBlog?.slug ? `/blog/${featuredBlog.slug}` : '/blog'}>
              <div className="relative h-full min-h-[500px] overflow-hidden rounded-3xl border border-slate-800 transition-all duration-500 hover:border-[#06b6d4]/50">
                {/* Background Image */}
                <div className="absolute inset-0">
                  {featuredBlog.thumbnail ? (
                    ...
                    <div className="h-full w-full bg-gradient-to-br from-[#06b6d4]/30 to-[#fc4c00]/30" />
                  )}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  <div className="mb-4 flex items-center gap-3">
                    <span className="rounded-full bg-[#fc4c00] px-3 py-1 text-xs font-bold text-white">
                      FEATURED
                    </span>
                  ...
                  <h3 className="mb-3 text-2xl font-bold text-white transition-colors group-hover:text-[#06b6d4] md:text-3xl">
                    {featuredBlog.title}
                  </h3>
            ...
            {otherBlogs.map((blog, index) => (
              ...
              >
                <Link href={blog?.slug ? `/blog/${blog.slug}` : '/blog'}>
                  <div className="flex gap-5 rounded-2xl border border-slate-800/50 bg-[#1E293B]/30 p-4 transition-all duration-300 hover:border-[#06b6d4]/30 hover:bg-[#1E293B]/50">
                    {/* Thumbnail */}
                    <div className="relative h-28 w-28 flex-shrink-0 overflow-hidden rounded-xl">
                      {blog.thumbnail ? (
                        ...
                        <div className="h-full w-full bg-gradient-to-br from-[#06b6d4]/20 to-[#fc4c00]/20" />
                      )}
                    </div>
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <h4 className="mb-2 mt-1 line-clamp-2 font-semibold text-white transition-colors group-hover:text-[#06b6d4]">
                        {blog.title}
                      </h4>
                    ...
                    <div className="flex items-center">
                      <ArrowRight className="h-5 w-5 text-slate-600 transition-all group-hover:translate-x-1 group-hover:text-[#06b6d4]" />
                    </div>
                  </div>
                </Link>
              </motion.article>
