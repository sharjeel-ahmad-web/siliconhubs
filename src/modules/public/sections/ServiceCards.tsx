...
import { GlowCard } from '@/modules/public/components/glow-card';
...
export default function ServiceCards() {
  ...
  const colors = {
    ...
    featureDotColor: sectionContent?.colors?.featureDotColor || '#06b6d4',
    linkColor: sectionContent?.colors?.linkColor || '#06b6d4',
    linkHoverColor: sectionContent?.colors?.linkHoverColor || '#fc4c00',
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Title */}
          <h3 className="mb-4 font-poppins text-2xl font-bold text-white">
            {card.title}
          </h3>
