    ...
    <section className="bg-[#0A0F1E] py-24 md:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 md:mb-24">
          <span className="mb-4 block text-sm font-bold uppercase tracking-[0.2em] text-[#06b6d4]">
            Our Work
          </span>
        ...
        <div className="mt-20 text-center">
          <a
            href="/portfolio"
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#06b6d4] to-[#2563EB] px-8 py-3 text-base font-semibold text-white transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#06b6d4]/30"
            style={{
              boxShadow:
