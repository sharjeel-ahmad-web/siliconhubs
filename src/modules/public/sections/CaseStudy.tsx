    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-16 text-center">
          <h2 className="mb-4 font-poppins text-4xl font-bold text-white md:text-5xl">
            {title}
          </h2>
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          >
            <div>
              <h3 className="mb-2 font-poppins text-3xl font-bold text-white">
                {client}
              </h3>
        ...
        <motion.div
          ...
          className="mt-20"
        >
          <h3 className="mb-8 text-center font-poppins text-3xl font-bold text-white">
            Before & After
          </h3>
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-[#1E293B]">
              <span className="font-poppins text-2xl text-[#64748B]">
                Before
              </span>
            </div>
            ...
            >
              <span className="font-poppins text-2xl text-white">After</span>
            </div>

            {/* Slider Handle */}
            <div
              className="absolute bottom-0 top-0 w-1 cursor-ew-resize bg-[#06b6d4]"
              style={{
                left: `${sliderPosition}%`,
                boxShadow: '0 0 20px rgba(139, 92, 246, 0.6)',
              }}
            >
              <div className="absolute left-1/2 top-1/2 flex h-12 w-12 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-[#06b6d4] shadow-lg">
                <svg
...
function MetricCard({
  ...
  return (
    ...
    >
      <div className="mb-2 font-poppins text-4xl font-bold text-[#06b6d4]">
        {metric.prefix}
