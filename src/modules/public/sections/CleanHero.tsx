...
const AnimatedBackground = dynamic(
  () =>
    import('@/modules/core/components/backgrounds/AnimatedBackground').catch(() => ({
      default: () => null,
    })),
  { ssr: false }
);
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-8 pt-16 md:py-12">
        <div className="mx-auto w-full max-w-5xl">
          <div className="flex flex-col items-center gap-8 text-center">
            ...
            {/* Main Heading */}
            <h1 className="bg-clip-text font-poppins text-4xl font-bold text-transparent sm:text-5xl md:text-6xl lg:text-7xl">
