...
import { BentoGrid, BentoGridItem } from '@/modules/public/components/bento-grid';
...
const ChatbotSkeleton = () => {
  ...
  return (
    <motion.div
      initial="initial"
      whileHover="animate"
      className="flex h-full min-h-[6rem] w-full flex-1 flex-col space-y-2 rounded-lg bg-gradient-to-br from-[#06b6d4]/10 to-transparent p-2"
    >
      <motion.div
        variants={variants}
        className="flex flex-row items-center space-x-2 rounded-full border border-[#06b6d4]/20 bg-[#1E293B] p-2"
      >
        <div className="h-6 w-6 shrink-0 rounded-full bg-gradient-to-r from-[#06b6d4] to-[#fc4c00]" />
        <div className="h-4 w-full rounded-full bg-slate-700" />
      </motion.div>
      <motion.div
        variants={variantsSecond}
        className="ml-auto flex w-3/4 flex-row items-center space-x-2 rounded-full border border-[#fc4c00]/20 bg-[#1E293B] p-2"
      >
        <div className="h-4 w-full rounded-full bg-slate-700" />
        <div className="h-6 w-6 shrink-0 rounded-full bg-gradient-to-r from-[#fc4c00] to-[#06b6d4]" />
      </motion.div>
      <motion.div
        variants={variants}
        className="flex flex-row items-center space-x-2 rounded-full border border-[#06b6d4]/20 bg-[#1E293B] p-2"
...
const AutomationSkeleton = () => {
  ...
  return (
    <motion.div
      ...
      animate="animate"
      whileHover="hover"
      className="flex h-full min-h-[6rem] w-full flex-1 flex-col space-y-2 rounded-lg bg-gradient-to-br from-[#fc4c00]/10 to-transparent p-2"
    >
      {arr.map((_, i) => (
        <motion.div
          key={'automation' + i}
          ...
          className="flex h-4 w-full flex-row items-center space-x-2 rounded-full border border-[#fc4c00]/20 bg-[#1E293B] p-2"
        ></motion.div>
      ))}
    </motion.div>
  );
...
const WordPressSEOSkeleton = () => {
  return (
    <motion.div
      ...
      animate="animate"
      whileHover="hover"
      className="flex h-full min-h-[6rem] w-full flex-1 flex-col items-center justify-center space-y-4 rounded-lg bg-gradient-to-br from-[#06b6d4]/10 to-[#fc4c00]/10 p-6"
    >
      {/* Top row: 3 icons */}
      ...
      <div className="mt-4 w-full max-w-xs space-y-2">
        <div className="relative h-3 w-full overflow-hidden rounded-full bg-gradient-to-r from-[#06b6d4] via-[#06b6d4] to-[#fc4c00]">
          <motion.div
...
const ShopifySkeleton = () => {
  return (
    <motion.div className="flex h-full min-h-[6rem] w-full flex-1 items-center justify-center rounded-lg bg-gradient-to-br from-[#fc4c00]/10 to-transparent p-4">
      <motion.div
        animate={{ rotateY: [0, 180, 360] }}
        transition={{ duration: 3, repeat: Infinity, ease: 'linear' }}
        className="flex h-32 w-24 items-center justify-center rounded-xl bg-gradient-to-br from-[#06b6d4] to-[#fc4c00] shadow-2xl"
      >
...
const items = [
  {
    ...
    icon: <MessageSquare className="h-4 w-4 text-[#06b6d4]" />,
  },
  {
    ...
    className: 'md:col-span-1',
    icon: <Workflow className="h-4 w-4 text-[#fc4c00]" />,
  },
  {
    ...
    className: 'md:col-span-1',
    icon: <Palette className="h-4 w-4 text-[#06b6d4]" />,
  },
  {
    title: 'WordPress & SEO',
    description:
    ...
    icon: <TrendingUp className="h-4 w-4 text-[#fc4c00]" />,
  },
  {
    title: 'Online Stores',
    description:
    ...
    className: 'md:col-span-1',
    icon: <ShoppingCart className="h-4 w-4 text-[#06b6d4]" />,
  },
];
