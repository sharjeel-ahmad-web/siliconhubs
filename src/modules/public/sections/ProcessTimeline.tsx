...
import RadialOrbitalTimeline from '@/modules/public/components/radial-orbital-timeline';

// Process timeline data for Silicon Hubs
const processData = [
  {
    id: 1,
    title: 'Discovery',
      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mx-auto mb-8 max-w-3xl text-center">
          <h2
            ...
            className={`font-poppins text-4xl font-bold transition-all duration-700 ease-out md:text-5xl ${
              headerInView
                ? 'translate-y-0 opacity-100'
                : 'translate-y-10 opacity-0'
            }`}
          >
            <span className="text-[#06b6d4]">Our</span>{' '}
