    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center gap-8 text-center">
          {/* Eyebrow */}
          <span className="inline-flex items-center gap-2 rounded-full border border-[#06b6d4]/30 bg-[#06b6d4]/10 px-6 py-3 text-sm font-medium uppercase tracking-wider text-[#06b6d4] backdrop-blur-sm">
          ...
          {/* Heading */}
          <h1 className="font-poppins text-5xl font-bold leading-tight text-white sm:text-6xl md:text-7xl lg:text-8xl">
            <span
