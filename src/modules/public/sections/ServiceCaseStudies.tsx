...
import {
  ...
  SliderContent,
  SliderWrapper,
} from '@/modules/public/components/progressive-carousel';
          ...
          <SliderBtnGroup className="absolute bottom-0 left-0 right-0 grid grid-cols-2 overflow-hidden rounded-b-2xl border-t border-white/10 bg-black/60 backdrop-blur-xl md:grid-cols-4">
            {caseStudies.map((item, index) => (
              <SliderBtn
                ...
                progressBarClass="bg-gradient-to-r from-[#fc4c00] to-[#06b6d4] h-full"
              >
                <h3 className="relative mb-2 inline-flex items-center gap-2 rounded-full bg-[#fc4c00] px-3 py-1 text-xs font-semibold text-white">
