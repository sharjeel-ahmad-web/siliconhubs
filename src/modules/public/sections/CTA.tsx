  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-8 px-4">
        <h2 className="text-center font-poppins text-3xl font-bold text-white md:text-5xl">
        ...
        <ParticleWrapper>
          <StarButton
            className="h-12 px-8 font-poppins text-base font-semibold transition-transform hover:scale-105"
            duration={2.5}
