  ...
  return (
    <div ref={dropdownRef} className="relative inline-block">
      <button
        ...
        className="flex min-w-[180px] cursor-pointer items-center gap-2 border-b-2 border-[#06b6d4]/50 bg-transparent px-2 py-1 text-[#06b6d4] outline-none transition-colors hover:border-[#fc4c00] focus:border-[#fc4c00]"
      >
        <span className={value ? 'text-[#06b6d4]' : 'text-[#64748B]/50'}>
          {selectedLabel}
        </span>
        <svg
          className={`h-4 w-4 text-[#06b6d4] transition-transform ${isOpen ? 'rotate-180' : ''}`}
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
          ...
          >
            {options.map((option) => (
              <button
                ...
                className={`w-full px-4 py-3 text-left text-base transition-colors hover:bg-[#06b6d4]/20 ${
                  value === option.value
          ...
          >
            {isSubmitted ? (
              <div className="py-12 text-center">
                <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-[#06b6d4]/20">
                  <svg
                    className="h-10 w-10 text-[#06b6d4]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <div className="font-inter text-xl leading-relaxed text-white md:text-2xl">
                  <p className="mb-6">
                    ...
                    <input
                      ...
                      required
                      className="min-w-[150px] border-b-2 border-[#06b6d4]/50 bg-transparent px-2 py-1 text-[#06b6d4] placeholder-[#64748B]/50 outline-none transition-colors focus:border-[#fc4c00]"
                    />
                  ...
                  <p className="mb-6">
                    ...
                    <input
                      ...
                      required
                      className="min-w-[200px] border-b-2 border-[#06b6d4]/50 bg-transparent px-2 py-1 text-[#06b6d4] placeholder-[#64748B]/50 outline-none transition-colors focus:border-[#fc4c00]"
                    />
                  </p>
                  ...
                  <p className="mb-6">
                    ...
                    <textarea
                      ...
                      required
                      rows={3}
                      className="mt-2 w-full resize-none rounded-xl border-2 border-[#06b6d4]/30 bg-transparent px-4 py-3 text-base text-[#06b6d4] placeholder-[#64748B]/50 outline-none transition-colors focus:border-[#fc4c00]"
                    />
                  </p>
                </div>
