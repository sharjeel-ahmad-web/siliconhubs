...
import { useAnalytics } from '@/modules/core/components/analytics/AnalyticsTracker';
...
export default function SpaceHero({ typewriterSpeed = 80 }: SpaceHeroProps) {
  ...
  const title = heroContent?.title || 'Silicon Hubs';
  const subtitle =
  ...
  return (
    ...
    >
      ...
      {/* Large Glowing Planet/Orb - Silicon Hubs Colors - z-5 */}
      <motion.div
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle at 30% 30%, #06b6d4 0%, #06b6d4 30%, #fc4c00 70%, transparent 100%)',
          }}
        />
        ...
        <motion.div
          ...
          style={{
            background: 'radial-gradient(circle, #fc4c00 0%, transparent 60%)',
          }}
          animate={{
            scale: [1.1, 1, 1.1],
        ...
        <motion.div
          ...
          style={{
            background:
              'radial-gradient(circle at 50% 50%, transparent 40%, #06b6d4 50%, transparent 60%)',
          }}
          animate={{
            rotate: [0, 360],
          }}
      ...
      >
        <div className="flex flex-col items-center justify-center gap-6 text-center">
          ...
          >
            <span className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-5 py-2 text-sm uppercase tracking-wide text-slate-300 backdrop-blur-sm transition-all duration-300 hover:border-[#06b6d4]/30 hover:bg-[#06b6d4]/10 md:text-base">
              {eyebrow}
              <svg
          ...
          <motion.h1
            className="font-poppins text-4xl font-bold text-white sm:text-5xl md:text-6xl lg:text-7xl"
            variants={{
              hidden: {},
              visible: {
                transition: {
          ...
          >
            <StarButton
              ...
              style={{
                background:
                  'linear-gradient(135deg, #06b6d4 0%, #06b6d4 50%, #06b6d4 100%)',
