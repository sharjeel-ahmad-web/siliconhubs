...
import { GradientMeshBackground } from '@/modules/public/components/gradient-mesh-bg';
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center gap-6 text-center">
          <p className="font-inter text-lg uppercase tracking-wide text-[#fc4c00] md:text-xl">
            {eyebrow}
          </p>

          <h1
            className="bg-clip-text font-poppins text-4xl font-bold text-transparent sm:text-5xl md:text-6xl lg:text-7xl"
            style={{
              backgroundImage:
      ...
      >
        <span className="font-inter text-sm text-[#06b6d4]">{scrollText}</span>
        <div className="flex h-10 w-6 justify-center rounded-full border-2 border-[#06b6d4] pt-2">
          <div className="h-3 w-1.5 animate-bounce rounded-full bg-[#fc4c00]" />
        </div>
      </div>
    </section>
  );
