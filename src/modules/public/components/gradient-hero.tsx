  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="absolute -right-60 -top-10 z-0 flex flex-col items-end blur-xl">
        <div className="z-1 h-[10rem] w-[60rem] rounded-full bg-gradient-to-b from-[#06b6d4] to-[#06b6d4] blur-[6rem]"></div>
        <div className="z-1 h-[10rem] w-[90rem] rounded-full bg-gradient-to-b from-[#fc4c00] to-[#06b6d4] blur-[6rem]"></div>
        <div className="z-1 h-[10rem] w-[60rem] rounded-full bg-gradient-to-b from-[#06b6d4] to-[#fc4c00] blur-[6rem]"></div>
      </div>
      ...
      <div className="relative z-10 pt-32">
        ...
        <div className="container mx-auto mt-8 px-4 text-center">
          <motion.h1
            ...
            className="mx-auto max-w-4xl font-poppins text-3xl font-bold leading-tight text-white md:text-4xl lg:text-5xl"
          >
            {titleHighlight ? (
              <>
                <span
          ...
          {(image || video) && (
            ...
            >
              <div className="absolute inset-0 rounded-2xl bg-[#06b6d4] opacity-20 blur-[8rem]" />
              {video ? (
                <video
                  src={video}
