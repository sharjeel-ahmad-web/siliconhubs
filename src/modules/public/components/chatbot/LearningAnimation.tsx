...
export const LearningAnimation: React.FC = () => {
  ...
  const getNodeColor = (node: Node) => {
    if (node.layer === 0) return '#fc4c00'; // Input - Orange
    if (node.layer === layers.length - 1) return '#06b6d4'; // Output - Brand Cyan
    return '#06b6d4'; // Hidden - Brand Blue
  };
  ...
  return (
    <div className="w-full">
      {/* Main visualization */}
      <div className="relative h-[450px] w-full overflow-hidden rounded-2xl border border-[#06b6d4]/30 bg-black">
        ...
        <div className="absolute left-4 top-4">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              exit={{ opacity: 0, x: 20 }}
              className="rounded-lg border border-[#06b6d4]/30 bg-black/80 px-4 py-2 backdrop-blur-sm"
            >
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
        <motion.div
          className={`rounded-xl border p-6 transition-all ${
            stage === 'input'
              ? 'border-[#fc4c00] bg-[#fc4c00]/10 shadow-lg shadow-[#fc4c00]/20'
              : 'border-[#06b6d4]/20 bg-black'
          }`}
          animate={{ scale: stage === 'input' ? 1.02 : 1 }}
        >
          <div className="mb-3 flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#fc4c00]/20">
              <svg
                className="h-5 w-5 text-[#fc4c00]"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <div className="text-lg font-semibold text-[#fc4c00]">
              Input Layer
            </div>
          </div>
        ...
        >
          <div className="mb-3 flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#06b6d4]/20">
              <svg
            ...
            <div className="text-lg font-semibold text-[#06b6d4]">
              Hidden Layers
            </div>
          </div>
          <p className="text-sm text-[#64748B]">
