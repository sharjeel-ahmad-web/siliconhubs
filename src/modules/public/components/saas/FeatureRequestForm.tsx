        ...
        >
          ...
          <div className="mb-8 grid gap-6 md:grid-cols-2">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-700 bg-[#0F172A] px-4 py-3 text-white placeholder-slate-500 transition-colors focus:border-[#06b6d4] focus:outline-none"
              />
            </div>
            <div>
              <label className="mb-2 block font-medium text-slate-300">
          ...
          <div className="mb-8">
            ...
            <textarea
              ...
              className="w-full resize-none rounded-xl border border-slate-700 bg-[#0F172A] px-4 py-3 text-white placeholder-slate-500 transition-colors focus:border-[#06b6d4] focus:outline-none"
            />
          </div>
