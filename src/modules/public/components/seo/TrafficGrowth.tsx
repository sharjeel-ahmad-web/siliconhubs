...
export function TrafficGrowth({
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      gradient.addColorStop(0, '#fc4c0040');
      gradient.addColorStop(1, '#fc4c0000');
      ...
      points.slice(0, visiblePoints + 1).forEach((point, i) => {
        ...
        glowGradient.addColorStop(0, '#fc4c0080');
        glowGradient.addColorStop(1, '#fc4c0000');
        ...
        // Point
        ctx.fillStyle = hoveredPoint === i ? '#fc4c00' : '#2563EB';
        ctx.beginPath();
    ...
    <div className="relative min-h-[600px] w-full overflow-hidden rounded-2xl bg-[#0F172A] p-8">
      ...
      <div className="absolute inset-0 opacity-5">
        <div
          ...
          style={{
            backgroundImage:
              'radial-gradient(circle at 2px 2px, #fc4c00 1px, transparent 0)',
            ...
            isVisible && (
              ...
              >
                <div className="relative -translate-x-1/2 transform">
                  ...
                  {/* Label */}
                  <div className="whitespace-nowrap rounded-lg bg-[#fc4c00] px-3 py-2 text-sm font-bold text-white shadow-lg">
                    {milestone.label}
                  </div>
                </div>
              </motion.div>
      ...
      <div className="relative z-10 grid grid-cols-4 gap-4">
        ...
        >
          ...
          <div className="text-2xl font-bold text-[#fc4c00]">
            {Math.round(
