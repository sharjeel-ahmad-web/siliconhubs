...
const defaultMetrics: MetricData[] = [
  { label: 'Revenue', target: 125000, unit: '$', color: '#fc4c00' },
  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-8">
        ...
        <div className="relative h-64">
          ...
          <div className="absolute inset-0 flex items-end justify-between gap-2">
            {chartData.map((value, index) => {
              ...
              const barColor =
                value > 70 ? '#fc4c00' : value > 40 ? '#2563EB' : '#fc4c00';
          ...
          <div className="pointer-events-none absolute inset-0">
            {[15, 35, 55, 75, 90].map((leftPos, i) => (
              <motion.div
                key={i}
                className="absolute h-2 w-2 rounded-full bg-[#fc4c00]"
                style={{
                  left: `${leftPos}%`,
      ...
      <div className="flex items-center justify-center gap-2 text-sm text-white/60">
        <motion.div
          className="h-2 w-2 rounded-full bg-[#fc4c00]"
          animate={{
            scale: [1, 1.5, 1],
            opacity: [0.5, 1, 0.5],
          }}
