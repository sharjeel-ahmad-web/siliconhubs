...
function MetricCard({ metric, index }: { metric: MetricItem; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="rounded-xl border border-[#fc4c00]/30 bg-gradient-to-br from-[#1E293B] to-[#0F172A] p-6 transition-colors duration-300 hover:border-[#fc4c00]"
    >
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="text-center">
          ...
          <p className="text-2xl font-bold text-[#fc4c00]">
      ...
      >
        <motion.div
          ...
          className="h-full bg-gradient-to-r from-[#fc4c00] to-[#EA580C]"
        />
      </motion.div>

      <p className="mt-2 text-center text-sm font-semibold text-[#fc4c00]">
