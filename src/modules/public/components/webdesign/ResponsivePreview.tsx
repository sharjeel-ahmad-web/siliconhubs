        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="h-full w-full overflow-auto bg-gradient-to-br from-[#1E293B] to-[#0F172A] p-4">
              {/* Header */}
              <motion.div
                className="mb-4 rounded-lg bg-gradient-to-r from-[#2563EB] to-[#06b6d4]"
                initial={{ height: 0 }}
                animate={{
                  height:
                    activeDevice === 'mobile'
              ...
              {/* Hero Section */}
              <motion.div
                className="mb-4 flex items-center justify-center rounded-lg bg-gradient-to-br from-[#2563EB]/20 to-[#06b6d4]/20"
                initial={{ height: 0 }}
                animate={{
                  height:
                    activeDevice === 'mobile'
