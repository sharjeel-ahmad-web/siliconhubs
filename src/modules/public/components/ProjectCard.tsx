  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Thumbnail */}
          <div className="relative h-48 bg-gradient-to-br from-[#06b6d4]/20 to-[#fc4c00]/20">
            <Image
              src={
          ...
          <div className="flex h-[calc(100%-192px)] flex-col p-4">
            <h3 className="mb-1 line-clamp-1 text-lg font-bold text-white transition-colors group-hover:text-[#06b6d4]">
              {project.title}
            </h3>
            ...
            <div className="mb-3 flex flex-wrap gap-1.5">
              {project.tags.slice(0, 3).map((tag) => (
                <span
                  key={tag}
                  className="rounded-full border border-[#06b6d4]/30 bg-[#06b6d4]/20 px-2 py-0.5 text-xs text-[#06b6d4]"
                >
                  {tag}
                </span>
              ))}
            ...
            <div className="mt-auto">
              <ParticleWrapper>
                <button
                  onClick={handleFlip}
                  className="text-sm text-[#06b6d4] transition-colors hover:text-[#fc4c00]"
                >
                  View Metrics →
                </button>
              </ParticleWrapper>
          ...
          {/* Hover effect */}
          <motion.div
            className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#06b6d4]/0 to-[#fc4c00]/0"
            whileHover={{
              background: [
            ...
            <div className="mb-6 space-y-4">
              {project.metrics.map((metric, index) => (
                ...
                >
                  ...
                  <span className="text-2xl font-bold text-[#fc4c00]">
                    {metric.value}
                  </span>
                </motion.div>
              ))}
