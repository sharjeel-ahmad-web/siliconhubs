  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 h-[350px] overflow-hidden lg:h-[525px]">
        <div 
          className="absolute bottom-[-280px] left-1/2 h-[350px] w-[490px] -translate-x-1/2 rounded-[100%] border border-[#06b6d4]/30 md:h-[350px] md:w-[770px] lg:bottom-[-420px] lg:h-[525px] lg:w-[980px]" 
          style={{ background: 'radial-gradient(closest-side at 50% 50%, #000 82%, #06b6d4)' }}
        />
      </div>
      ...
      <div className="relative z-10 pb-12 pt-12">
        ...
        {eyebrow && (
          <a href="#" className="group inline-block">
            <span className="mx-auto flex w-fit items-center justify-center rounded-3xl border-[2px] border-[#06b6d4]/20 bg-gradient-to-tr from-[#06b6d4]/10 via-gray-400/5 to-transparent px-5 py-2 text-sm uppercase tracking-tight text-gray-400">
              {eyebrow}
