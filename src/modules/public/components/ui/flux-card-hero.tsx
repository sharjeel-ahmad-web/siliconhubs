      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col items-center justify-center px-6 pb-16 pt-32">
        ...
        <div className="relative mx-auto w-full max-w-3xl">
          ...
          <div className="absolute inset-0 rotate-3 scale-95 transform transition-all duration-1000 ease-in-out">
            <div
              className={`h-72 w-full rounded-3xl bg-[#fc4c00]/60 opacity-50 shadow-2xl transition-all duration-1000 ${
          ...
          <div className="scale-96 absolute inset-0 -rotate-2 transform transition-all delay-300 duration-1000 ease-in-out">
            <div
              className={`h-76 w-full rounded-3xl bg-[#06b6d4]/60 opacity-60 shadow-2xl transition-all duration-1000 ${
          ...
          <div className="scale-97 absolute inset-0 rotate-1 transform transition-all delay-500 duration-1000 ease-in-out">
            <div
              className={`h-72 w-full rounded-3xl bg-[#06b6d4]/50 opacity-50 shadow-2xl transition-all duration-1000 ${
          ...
          <div className="scale-98 absolute inset-0 -rotate-1 transform transition-all delay-700 duration-1000 ease-in-out">
            <div
              className={`h-72 w-full rounded-3xl bg-[#fc4c00]/40 opacity-40 shadow-2xl transition-all duration-1000 ${
        ...
        <div className="relative mt-4">
          <div className="flex items-center justify-between">
            ...
            <div className="relative mx-2 h-0.5 flex-1 bg-white/30">
              <div className="absolute -top-1 right-0 h-3 w-3 animate-ping rounded-full bg-[#06b6d4]" />
            </div>
            <div className="text-center">
              <div className="mb-2 flex h-12 w-12 items-center justify-center rounded-xl bg-[#fc4c00]">
                <Zap className="h-5 w-5 text-white" />
              </div>
              <div className="text-xs text-black/80">Process</div>
            </div>
            <div className="relative mx-2 h-0.5 flex-1 bg-white/30">
              <div className="absolute -top-1 right-0 h-3 w-3 animate-ping rounded-full bg-[#fc4c00]" />
            </div>
            <div className="text-center">
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="h-2.5 w-full rounded-full bg-white/30">
            <div
              className="h-2.5 rounded-full bg-gradient-to-r from-[#06b6d4] to-[#fc4c00]"
              style={{ width: '28%' }}
            />
          </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="rounded-xl bg-white/20 p-3">
            ...
            <div className="mt-1 text-xs text-[#06b6d4]">Excellent</div>
          </div>
        </div>
      </div>
    </>
