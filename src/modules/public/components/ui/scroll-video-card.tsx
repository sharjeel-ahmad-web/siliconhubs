                ...
                <div ref={overlayContentRef} className="max-w-3xl space-y-6">
                  {overlay.caption && (
                    <div ref={overlayCaptionRef} className="mb-4">
                      <span className="inline-flex items-center gap-2 rounded-full border border-[#fc4c00]/30 bg-[#fc4c00]/20 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-[#fc4c00]">
