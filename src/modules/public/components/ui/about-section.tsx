        ...
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-center gap-6 px-4 md:flex-row md:gap-8 md:px-0">
          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="flex flex-col gap-8">
              ...
              >
                <div className="flex size-12 shrink-0 items-center justify-center rounded-xl border border-[#06b6d4]/30 bg-gradient-to-br from-[#06b6d4]/20 to-[#06b6d4]/5 p-2.5">
                  <img
              ...
              >
                <div className="flex size-12 shrink-0 items-center justify-center rounded-xl border border-[#fc4c00]/30 bg-gradient-to-br from-[#fc4c00]/20 to-[#fc4c00]/5 p-2.5">
                  <img
