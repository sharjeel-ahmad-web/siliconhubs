...
export const WorkflowBuilder: React.FC<WorkflowBuilderProps> = ({
  ...
  return (
    <div
      ref={canvasRef}
      className="relative h-[500px] w-full select-none overflow-hidden rounded-2xl border border-[#06b6d4]/20 bg-[#1a1a2e]"
    ...
    >
      ...
      {/* Add node button */}
      <motion.button
        className="absolute bottom-6 left-1/2 flex -translate-x-1/2 items-center gap-2 rounded-full border border-[#06b6d4]/50 bg-[#06b6d4]/20 px-4 py-2 text-sm font-medium text-[#06b6d4] transition-colors hover:bg-[#06b6d4]/30"
