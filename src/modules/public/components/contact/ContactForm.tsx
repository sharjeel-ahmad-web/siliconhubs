...
export default function ContactForm() {
  ...
  const emitConfetti = () => {
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      newParticles.push({
        ...
        life: 1.0,
        color: ['#06b6d4', '#2563EB', '#06b6d4', '#fc4c00'][
  ...
  const handleBlur = (
    ...
    if (error) {
      ...
      const rect = e.target.getBoundingClientRect();
      emitParticles(rect.width / 2, rect.height / 2, '#06b6d4', 8);
    }
      ...
      <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
        ...
        <ParticleWrapper className="w-full">
          <StarButton
            ...
            backgroundColor={submitSuccess ? '#06b6d4' : undefined}
    ...
    <div className="relative">
      ...
      <motion.label
        ...
        animate={{
          ...
          color: error ? '#EF4444' : isFocused ? '#06b6d4' : '#64748B',
        }}
