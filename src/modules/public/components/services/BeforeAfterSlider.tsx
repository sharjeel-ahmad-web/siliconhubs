...
export const BeforeAfterSlider: React.FC<BeforeAfterSliderProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-gradient-to-br from-[#2563EB] to-[#06b6d4]"
        style={{
        ...
        <div className="flex h-full flex-col items-center justify-center p-8">
          ...
          <div className="w-full max-w-md space-y-4">
            {automated.steps.map((item) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#06b6d4] font-bold text-white">
                    {item.step}
                  </div>
                  <span className="text-white">{item.text}</span>
                </div>
                <span className="font-medium text-[#06b6d4]">{item.time}</span>
              </div>
            ))}
          </div>
          <div className="mt-8 text-center">
