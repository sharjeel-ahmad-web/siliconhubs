...
export const PerformanceMetrics: React.FC<PerformanceMetricsProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Additional Details */}
      <motion.div
        className="col-span-1 mt-8 rounded-lg border border-[#2563EB]/20 bg-gradient-to-r from-[#2563EB]/10 to-[#06b6d4]/10 p-8 md:col-span-2 lg:col-span-4"
        initial={{ opacity: 0, y: 20 }}
        animate={isInView ? { opacity: 1, y: 0 } : {}}
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {benefits.map((benefit, idx) => (
            <div key={idx} className="flex items-start gap-3">
              <div className="mt-1 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-[#06b6d4]">
