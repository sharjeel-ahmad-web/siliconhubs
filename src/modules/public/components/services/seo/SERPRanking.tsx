    ...
    <div className="relative min-h-[550px] w-full overflow-hidden rounded-2xl bg-[#0F172A] p-8">
          ...
          return (
            ...
            >
              <div
                ...
                ${isTopThree ? 'border-[#fc4c00] bg-[#fc4c00]/10' : 'border-[#64748B]/30 bg-[#1E293B]/50'}
              ...
              >
                ...
                <div
                  ...
                  ${isTopThree ? 'bg-[#fc4c00] text-white' : 'bg-[#64748B]/30 text-[#64748B]'}
                `}
                >
                  #{position}
                </div>
                  ...
                  {keyword && (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <motion.div
                          className="flex items-center gap-1 text-sm font-medium text-[#fc4c00]"
                ...
                {keyword && (
                  <motion.div
                    className="h-12 w-2 rounded-full bg-gradient-to-b from-[#fc4c00] to-[#2563EB]"
                    initial={{ scaleY: 0 }}
                    animate={{ scaleY: 1 }}
      ...
      <div className="relative z-10 mt-8 flex gap-6 text-sm">
        <div className="flex items-center gap-2">
          <div className="h-3 w-3 rounded-full bg-[#fc4c00]" />
