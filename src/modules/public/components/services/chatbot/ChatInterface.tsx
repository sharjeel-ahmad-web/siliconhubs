      ...
      <div className="border-t border-[#64748B]/20 p-4">
        <div className="flex space-x-2">
          <input
            ...
            className="flex-1 rounded-lg border border-[#64748B]/20 bg-[#1E293B] px-4 py-3 text-white transition-all focus:border-[#06b6d4] focus:outline-none focus:ring-2 focus:ring-[#06b6d4]/20"
          />
          <motion.button
            onClick={handleSend}
