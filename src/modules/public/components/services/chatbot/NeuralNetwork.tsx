...
function NeuronSphere({
  ...
  const getColor = () => {
    if (layerType === 'input') return '#fc4c00'; // Orange
    if (layerType === 'output') return '#06b6d4'; // Brand Cyan
    return '#06b6d4'; // Brand Blue for hidden
  };
...
function ConnectionLine({
  ...
  const getColor = (layer: string) => {
    if (layer === 'input') return '#fc4c00';
    if (layer === 'output') return '#06b6d4';
    return '#06b6d4';
  };
  ...
  const material = new THREE.LineBasicMaterial({
    color: isActive ? getColor(fromLayer) : '#06b6d4',
...
function NetworkScene() {
  ...
  return (
    <>
      ...
      <pointLight position={[10, 10, 10]} intensity={0.6} color="#fc4c00" />
...
export const NeuralNetwork: React.FC = () => {
  return (
    <div className="relative h-[550px] w-full overflow-hidden rounded-2xl border border-[#06b6d4]/30 bg-black">
      <div
        tabIndex={-1}
      ...
      <div className="pointer-events-none absolute bottom-6 left-0 right-0 flex justify-around px-8">
        <div className="text-center">
          <div className="text-base font-semibold text-[#fc4c00]">
            Input Layer
          </div>
          <div className="text-xs text-[#64748B]">User Message</div>
        </div>
        <div className="text-center">
          <div className="text-base font-semibold text-[#06b6d4]">
            Hidden Layer 1
          </div>
      ...
      {/* Animated indicator */}
      <div className="absolute left-4 top-4 rounded-lg border border-[#06b6d4]/30 bg-black/80 px-4 py-2 backdrop-blur-sm">
