      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-12 text-center">
          ...
          <h2 className="mt-4 text-4xl font-bold text-white md:text-5xl">
            {title} <span className="text-[#06b6d4]">{titleHighlight}</span>
          </h2>
          ...
          <div className="flex items-center justify-between border-b border-slate-700/50 bg-[#1E293B] px-6 py-4">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span className="absolute -right-1 -top-1 h-2 w-2 rounded-full bg-[#fc4c00]" />
              </motion.div>
              <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[#06b6d4] to-[#2563EB]" />
            </div>
          </div>
              ...
              <div className="flex h-48 items-end justify-between gap-2">
                {chartData.map((data, i) => {
                  ...
                  return (
                    ...
                    >
                      <motion.div
                        className="min-h-[8px] w-full rounded-t bg-gradient-to-t from-[#06b6d4] to-[#2563EB]"
                        initial={{ height: 8 }}
