...
const defaultColorSwatches: ColorSwatch[] = [
  ...
  { name: 'Sky Blue', color: '#06b6d4', image: 'skyblue' },
];
  ...
  return (
    <div className="relative mx-auto w-full max-w-4xl">
            ...
            <div className="pointer-events-none absolute inset-0">
              {Array.from({ length: 15 }).map((_, i) => {
                ...
                return (
                  <motion.div
                    key={i}
                    className="absolute h-3 w-3 rounded-full bg-[#fc4c00]"
                    style={{
                      left: '50%',
                      top: '50%',
                      boxShadow: '0 0 10px #fc4c00',
                    }}
      ...
      <div className="mt-12 flex justify-center">
        <motion.button
          className="relative overflow-hidden rounded-lg bg-gradient-to-r from-[#fc4c00] to-[#2563EB] px-8 py-4 font-bold text-white"
