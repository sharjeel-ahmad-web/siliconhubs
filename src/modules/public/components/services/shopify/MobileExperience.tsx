          ...
          <div className="relative h-full w-full overflow-hidden rounded-[2.5rem] bg-white">
            ...
            <AnimatePresence mode="wait">
              {currentScreen === 'home' && (
                ...
                >
                  {/* Header */}
                  <div className="bg-gradient-to-r from-[#2563EB] to-[#fc4c00] p-6 text-white">
                    ...
                    {products.map((product, index) => (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <button className="rounded-lg bg-[#fc4c00] px-4 py-2 text-sm font-semibold text-white">
                            View
                          </button>
                        </div>
                      </motion.div>
              ...
              {currentScreen === 'product' && (
                ...
                >
                  ...
                  {/* Product Image */}
                  <div className="flex h-64 items-center justify-center bg-gradient-to-br from-[#2563EB] to-[#fc4c00]">
                    <motion.div
                      className="text-9xl"
                      animate={{
                        rotate: [0, 10, -10, 0],
                  ...
                  <div className="space-y-4 p-6">
                    ...
                    <div className="flex gap-3">
                      {['#1E293B', '#2563EB', '#fc4c00'].map((color, i) => (
                        <motion.button
                          key={color}
                    ...
                    {/* Add to cart button */}
                    <motion.button
                      className="w-full rounded-xl bg-gradient-to-r from-[#fc4c00] to-[#2563EB] py-4 font-bold text-white"
                      whileTap={{ scale: 0.98 }}
              ...
              {currentScreen === 'cart' && (
                ...
                >
                  ...
                  <div className="flex h-full flex-col items-center justify-center p-6">
                    <motion.div
                      className="mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-[#fc4c00]"
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                      transition={{
                        type: 'spring',
                    ...
                    <motion.button
                      className="mb-3 w-full rounded-xl bg-gradient-to-r from-[#2563EB] to-[#fc4c00] py-4 font-bold text-white"
                      whileTap={{ scale: 0.98 }}
                    >
                      {checkoutText}
                    </motion.button>
