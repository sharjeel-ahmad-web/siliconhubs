...
import SubmitTestimonialModal from '@/modules/public/components/testimonials/SubmitTestimonialModal';
      ...
      >
        ...
        <div className="relative mx-auto mb-16 max-w-6xl">
            ...
            <AnimatePresence initial={false} custom={direction}>
              ...
              >
                <div className="group relative h-full overflow-hidden rounded-3xl border border-white/[0.15] bg-gradient-to-br from-white/[0.08] to-white/[0.02] p-8 backdrop-blur-xl md:p-12">
                  ...
                  <motion.div
                    className="absolute inset-0 rounded-3xl bg-gradient-to-br from-[#fc4c00]/[0.08] via-[#06b6d4]/[0.05] to-[#fc4c00]/[0.08]"
                    animate={{
                  ...
                  >
                    <Quote className="h-16 w-16 text-[#fc4c00]" />
                  </motion.div>
                  ...
                  <div className="relative z-10 flex h-full flex-col items-center gap-8 md:flex-row">
                    ...
                    <div className="flex-shrink-0 text-center md:text-left">
                      ...
                      >
                        <div className="relative mx-auto h-24 w-24 overflow-hidden rounded-full border-4 border-[#fc4c00]/30 md:mx-0">
                          <img
                          ...
                          />
                          <motion.div
                            className="absolute inset-0 bg-gradient-to-br from-[#fc4c00]/20 to-[#06b6d4]/20"
                        ...
                        <motion.div
                          className="absolute inset-0 rounded-full border-2 border-[#fc4c00]/30"
                          animate={{
                            scale: [1, 1.4, 1],
                            opacity: [0.5, 0, 0.5],
                          }}
                      ...
                      <p className="mb-1 font-medium text-[#fc4c00]">
          ...
          <div className="mt-8 flex items-center justify-center gap-6">
            <motion.button
              ...
              className="rounded-full border border-white/[0.15] bg-white/[0.08] p-3 text-white backdrop-blur-sm transition-all hover:bg-[#fc4c00]/20"
              whileHover={{
                scale: 1.1,
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              <motion.div
                className="mb-2 bg-gradient-to-r from-[#fc4c00] to-[#06b6d4] bg-clip-text text-3xl font-bold text-transparent md:text-4xl"
