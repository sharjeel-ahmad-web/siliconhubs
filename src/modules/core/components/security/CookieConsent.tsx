        ...
        <div className="p-6">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-[#2563EB] transition-colors hover:text-[#06b6d4]"
            >
            ...
            {showDetails ? (
              <button
                ...
                className="rounded-lg bg-[#2563EB] px-6 py-2 text-sm font-medium text-white transition-colors hover:bg-[#06b6d4]"
              >
                Save Preferences
              </button>
            ) : (
