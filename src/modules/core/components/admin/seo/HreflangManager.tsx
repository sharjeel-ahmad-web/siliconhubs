    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-4">
        <div className="flex items-start gap-3">
          <Languages className="mt-0.5 h-5 w-5 flex-shrink-0 text-[#06b6d4]" />
          <div>
        ...
        <div className="space-y-6 lg:col-span-2">
          <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-6">
            <div className="mb-4 flex items-center justify-between">
              ...
              <button
                onClick={addLanguage}
                className="flex items-center gap-2 rounded-lg bg-[#06b6d4] px-3 py-1.5 text-sm text-white hover:bg-[#06b6d4]/80"
              >
            ...
            <button
              onClick={handleSave}
              disabled={saving}
              className="mt-6 flex items-center gap-2 rounded-lg bg-[#06b6d4] px-6 py-2 text-white hover:bg-[#06b6d4]/80 disabled:opacity-50"
            >
