          ...
          <div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex items-center gap-2 rounded-lg px-4 py-2 ${device === 'mobile' ? 'bg-[#06b6d4] text-white' : 'bg-slate-700 text-slate-300'}`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-2 rounded-lg px-4 py-2 ${device === 'desktop' ? 'bg-[#06b6d4] text-white' : 'bg-slate-700 text-slate-300'}`}
              >
