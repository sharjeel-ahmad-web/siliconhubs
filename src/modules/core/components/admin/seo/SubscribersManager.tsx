      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-4">
          <div className="flex items-center gap-3">
            <div className="rounded-lg bg-[#06b6d4]/20 p-2">
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row">
        <div className="flex flex-1 gap-4">
          <div className="relative max-w-md flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-700 bg-[#1E293B] py-2 pl-10 pr-4 text-white focus:border-[#06b6d4] focus:outline-none"
            />
          </div>
          <select
            value={statusFilter}
            ...
            className="rounded-lg border border-slate-700 bg-[#1E293B] px-4 py-2 text-white focus:border-[#06b6d4] focus:outline-none"
          >
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-[#06b6d4] px-4 py-2 text-white hover:bg-[#06b6d4]/80"
          >
        ...
        <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-6">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            <input
              ...
              className="rounded-lg border border-slate-700 bg-[#0F172A] px-3 py-2 text-white focus:border-[#06b6d4] focus:outline-none"
            />
            <input
              type="text"
          ...
          <div className="mt-4 flex justify-end">
            <button
              ...
              className="rounded-lg bg-[#06b6d4] px-6 py-2 text-white hover:bg-[#06b6d4]/80"
            >
              Add Subscriber
            </button>
          </div>
                  ...
                  <tr>
                    <th className="px-4 py-3 text-left">
                      <input
                        ...
                        className="h-4 w-4 rounded border-slate-600 bg-[#0F172A] text-[#06b6d4]"
                      />
                    </th>
