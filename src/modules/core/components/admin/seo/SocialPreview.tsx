            ...
            {[
              ...
              <button
                ...
                className={`rounded-lg p-3 transition-colors ${
                  previewType === id
                    ? 'bg-slate-700 ring-2 ring-[#06b6d4]'
        ...
        {previewType === 'google' && (
          <div className="max-w-2xl rounded-lg bg-white p-4">
            <div className="mb-1 flex items-center gap-2">
              ...
              <div>
                <p className="text-sm text-[#202124]">Silicon Hubs</p>
      ...
      <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-6">
        ...
        <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
          <div className="rounded-lg bg-[#0F172A] p-3">
            <p className="mb-1 font-medium text-[#06b6d4]">OG Image</p>
            <p className="text-slate-400">
              Recommended size: 1200x630px for best display across platforms
            </p>
          </div>
          <div className="rounded-lg bg-[#0F172A] p-3">
            <p className="mb-1 font-medium text-[#06b6d4]">Title Length</p>
            <p className="text-slate-400">
              Keep under 60 characters for Google, 70 for social media
            </p>
          </div>
          <div className="rounded-lg bg-[#0F172A] p-3">
            <p className="mb-1 font-medium text-[#06b6d4]">Description</p>
            <p className="text-slate-400">
              150-160 characters for Google, up to 200 for social
            </p>
          </div>
          <div className="rounded-lg bg-[#0F172A] p-3">
            <p className="mb-1 font-medium text-[#06b6d4]">Test Your Links</p>
            <p className="text-slate-400">
