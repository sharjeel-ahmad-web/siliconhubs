              ...
              {user.two_factor_enabled ? (
                <>
                  ...
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      maxLength={6}
                      placeholder="000000"
                      className="w-full rounded-lg border border-slate-700 bg-[#0F172A] px-3 py-2 text-center text-2xl tracking-widest text-white placeholder-slate-500 focus:border-[#06b6d4] focus:outline-none"
                    />
                    <button
                ...
                <>
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full rounded-lg bg-[#06b6d4] px-4 py-2 text-white transition-colors hover:bg-[#06b6d4]/80 disabled:cursor-not-allowed disabled:opacity-50"
                  >
          ...
          {step === 'setup' && (
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full rounded-lg bg-[#06b6d4] px-4 py-2 text-white transition-colors hover:bg-[#06b6d4]/80"
              >
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    disabled={loading || token.length !== 6}
                    className="flex-1 rounded-lg bg-[#06b6d4] px-4 py-2 text-white transition-colors hover:bg-[#06b6d4]/80 disabled:cursor-not-allowed disabled:opacity-50"
                  >
