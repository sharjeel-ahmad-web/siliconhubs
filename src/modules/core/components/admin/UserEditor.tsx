        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-6">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required={!user?.id}
                className="w-full rounded-lg border border-slate-700 bg-[#0F172A] px-3 py-2 pr-10 text-white placeholder-slate-400 focus:border-[#06b6d4] focus:outline-none"
                placeholder={
          ...
          <div className="flex gap-3 border-t border-slate-700 pt-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-[#06b6d4] px-4 py-2 text-white transition-colors hover:bg-[#06b6d4]/80 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {loading ? (
                <>
