...
export default function AnalyticsDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Real-Time Metrics */}
      <div className="rounded-xl bg-gradient-to-r from-[#2563EB] to-[#06b6d4] p-6 text-white">
                ...
                >
                  <div className="flex w-full flex-1 items-end px-1">
                    <motion.div
                      ...
                      className="w-full rounded-t bg-gradient-to-t from-[#06b6d4] to-[#fc4c00]"
                      style={{ maxHeight: '100%' }}
                    />
                  </div>
                </div>
  ...
  return (
    <div className="space-y-1">
      ...
      <motion.div
        ...
        className="flex h-12 items-center justify-center rounded bg-gradient-to-r from-[#06b6d4] to-[#fc4c00] font-semibold text-white"
      >
        {width.toFixed(0)}%
      </motion.div>
    </div>
