  ...
  return (
    <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-6 shadow-lg transition-all hover:border-slate-600/50 hover:shadow-xl">
        ...
        <div className="mb-4">
          ...
          <ul className="space-y-2">
            {section.editableContent.map((content, idx) => (
              ...
              >
                <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#06b6d4]/10 text-xs font-medium text-[#06b6d4]">
                  {idx + 1}
                </span>
      ...
      <div className="flex flex-wrap gap-2">
        <a
          href={`https://github.com/achagames6-web/silicon-hubs-agency/blob/main/${section.filePath}`}
          target="_blank"
        ...
        {section.cmsEnabled && section.cmsPath && (
          <a
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-[#06b6d4]/30 bg-[#06b6d4]/10 px-3 py-1.5 text-xs font-medium text-[#06b6d4] transition-colors hover:bg-[#06b6d4]/20"
          >
