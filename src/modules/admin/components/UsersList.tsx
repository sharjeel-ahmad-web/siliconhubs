      ...
      <div className="flex flex-col gap-4 sm:flex-row">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-700 bg-[#1E293B] py-2 pl-10 pr-4 text-white placeholder-slate-400 focus:border-[#06b6d4] focus:outline-none"
          />
        </div>
      ...
      <div className="overflow-hidden rounded-xl border border-slate-700/50 bg-[#1E293B]">
        {loading ? (
          <div className="p-12 text-center">
            <div className="inline-block h-8 w-8 animate-spin rounded-full border-4 border-[#06b6d4]/30 border-t-[#06b6d4]"></div>
