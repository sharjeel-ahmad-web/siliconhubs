      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-6 lg:col-span-2">
          ...
          <textarea
            ...
            className="h-96 w-full resize-none rounded-lg border border-slate-700 bg-[#0F172A] px-4 py-3 font-mono text-sm text-white focus:border-[#06b6d4] focus:outline-none"
            spellCheck={false}
          />
          ...
          <div className="mt-4 flex justify-end">
            <button
              onClick={handleSave}
              disabled={saving}
              className="flex items-center gap-2 rounded-lg bg-[#06b6d4] px-6 py-2 text-white hover:bg-[#06b6d4]/80 disabled:opacity-50"
            >
              {saving ? (
        ...
        <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-6">
          ...
          <div className="space-y-4 text-sm">
            <div>
              <code className="text-[#06b6d4]">User-agent: *</code>
            ...
            <div>
              <code className="text-[#06b6d4]">Allow: /path/</code>
              <p className="mt-1 text-slate-400">
            ...
            <div>
              <code className="text-[#06b6d4]">Disallow: /path/</code>
              <p className="mt-1 text-slate-400">
            ...
            <div>
              <code className="text-[#06b6d4]">Sitemap: URL</code>
              <p className="mt-1 text-slate-400">
            ...
            <div>
              <code className="text-[#06b6d4]">Crawl-delay: 10</code>
              <p className="mt-1 text-slate-400">
