    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-6">
          ...
          <button
            onClick={handleSave}
            className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg bg-[#06b6d4] px-4 py-2 text-white hover:bg-[#06b6d4]/80"
          >
                    ...
                    <div className="flex items-start justify-between">
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-2 flex gap-2">
                          <span className="rounded bg-[#06b6d4]/20 px-2 py-0.5 text-xs text-[#06b6d4]">
                            {link.source}
                          </span>
