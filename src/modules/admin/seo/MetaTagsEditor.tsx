              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-lg border border-slate-700 bg-[#0F172A] px-3 py-2 text-white focus:border-[#06b6d4] focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div className="flex gap-6">
                <label className="flex cursor-pointer items-center gap-2">
                  <input
                    ...
                    className="h-4 w-4 rounded border-slate-600 bg-[#0F172A] text-[#06b6d4] focus:ring-[#06b6d4]"
                  />
