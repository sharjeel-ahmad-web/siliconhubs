  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        ...
        <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-4">
          <div className="flex items-center gap-2">
            <Link2 className="h-5 w-5 text-[#06b6d4]" />
            <p className="text-2xl font-bold text-[#06b6d4]">{internalCount}</p>
          </div>
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row">
        ...
        <button
          ...
          disabled={scanning}
          className="flex items-center gap-2 rounded-lg bg-[#06b6d4] px-4 py-2 text-white hover:bg-[#06b6d4]/80 disabled:opacity-50"
        >
      ...
      {scanning && (
        <div className="rounded-xl border border-slate-700/50 bg-[#1E293B] p-4">
          ...
          <div className="h-2 w-full rounded-full bg-slate-700">
            <div
              className="h-2 rounded-full bg-[#06b6d4] transition-all duration-300"
              ...
              <tbody className="divide-y divide-slate-700">
                {filteredLinks.map((link) => (
                  <tr key={link._id} className="hover:bg-slate-700/30">
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`inline-flex items-center gap-1 text-xs ${link.type === 'internal' ? 'text-[#06b6d4]' : 'text-purple-400'}`}
                      >
                        {link.type === 'internal' ? (
