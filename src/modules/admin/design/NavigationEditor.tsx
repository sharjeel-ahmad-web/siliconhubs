      ...
      <div className="flex items-center justify-between">
        <div className="flex gap-2">
          <button
            ...
            className={`rounded-lg px-4 py-2 font-medium ${activeSection === 'header' ? 'bg-[#06b6d4] text-white' : 'bg-slate-700 text-slate-300'}`}
          >
            Header Navigation
          </button>
          <button
            onClick={() => setActiveSection('footer')}
            className={`rounded-lg px-4 py-2 font-medium ${activeSection === 'footer' ? 'bg-[#06b6d4] text-white' : 'bg-slate-700 text-slate-300'}`}
          >
            Footer Navigation
          </button>
        </div>
              ...
              <div key={item.id} className="rounded-lg bg-[#0F172A] p-4">
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="p-1.5 text-slate-400 hover:text-[#06b6d4]"
                    title="Add submenu"
                  >
                    <Plus className="h-4 w-4" />
                  </button>
